...
EA 6300';
  ...
  function agent($id, $nom,$prenom,$add1,$add2,$res1,$res2, $equipe,$intitule, $grade, $personnel_type, $signature_path, $date_naissance) {
...
Certifié exact par l'interessé(e)                                   A Tours , le ........... Signature";
  ...
  function mission($motif,$complementMotif,$lieu,$date_a,$heure_ad,$heure_aa,$date_r,$heure_ra,$heure_rd,$nb_repas,$nb_nuite) {
	//TITRE
	$this->setXY(10,127);
	$this->setFont('Times','B',16);
...
$transportDisplay";
  ...
  function transportBis($immat,$puiss,$commentaire,$reducSncf,$billetAgence) {
	//titre
	$this->setXY(10, 181);
	$this->SetFont('Times','B',10);
...
Puissance ficale du véhicule : $puiss";
  ...
  function signatures($cheifSignaturePath) {
	// signature de gauche
	$this->setXY(12,233);
	$this->setFont('times','B',10);
