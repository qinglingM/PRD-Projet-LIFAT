...
class pdfValid extends FPDF
{
    ...
    public function LIFAT($matricule, $dateCurrent)
    {
    ...
    public function agent($id, $nom, $prenom, $email, $equipe, $date_naissance)
    {
    ...
    public function mission($motif, $complementMotif, $lieu, $personnel_type)
    {
        //TITRE
        $this->SetXY(10, 110);
        $this->SetFont('Times', 'B', 16);
        ...
        $this->Cell(30, 0, utf8_decode('Autre(précisez) : '), 0, 0, 'L');
...
//    if ($transport->type_transport == 'autre')
        ...
        $this->SetXY(15, 225);
        $this->Cell(30, 0, utf8_decode('Recours au marché(train et/ou avion)'), 0, 0, 'L');
...
//     $this->setXY(-90, 149);
    ...
    public function signatures($signature_path, $cheifSignaturePath, $juridiqueSignaturePath, $presidentSignaturePath)
    {
